/* Polizing — Lucide-style icon set (inline SVG components) */
const Icon = ({ d, children, size = 16, sw = 2, fill = "none", style }) => (
  <svg
...
const I = {
  ...
  Building: (p) => <Icon {...p}><rect x="3" y="3" width="18" height="18" rx="2" /><path d="M9 22V12h6v10" /><path d="M8 6h.01M12 6h.01M16 6h.01M8 10h.01M12 10h.01M16 10h.01" /></Icon>,
  ...
  Wallet: (p) => <Icon {...p}><path d="M19 7V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a4 4 0 0 0 4 4h12a2 2 0 0 0 2-2v-2" /><path d="M21 12v4h-4a2 2 0 0 1 0-4Z" /></Icon>,
  ...
  EyeOff: (p) => <Icon {...p}><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94" /><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19" /><path d="m1 1 22 22" /><path d="M14.12 14.12a3 3 0 1 1-4.24-4.24" /></Icon>,
  ...
  Trash: (p) => <Icon {...p}><polyline points="3 6 5 6 21 6" /><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /></Icon>,
  WhatsApp: (p) => <Icon {...p}><path d="M3 21l1.65-3.8a9 9 0 1 1 3.4 2.9z" /><path d="M9 10a.5.5 0 0 0 1 0V9a.5.5 0 0 0-1 0v1a5 5 0 0 0 5 5h1a.5.5 0 0 0 0-1h-1a.5.5 0 0 0 0 1" /></Icon>,
  ...
  Sort: (p) => <Icon {...p}><path d="M3 6h18M7 12h10M10 18h4" /></Icon>,
  ...
  Eye2: (p) => <Icon {...p}><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7z" /><circle cx="12" cy="12" r="3" /></Icon>,
