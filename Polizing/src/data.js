/* Polizing — Hardcoded data (Argentina) */
...
// ============== CLIENTES ==============
const CLIENTES = [
  { id: "C001", tipo: "corp", razonSocial: "Logística del Sur S.A.", cuit: "30-71045892-7", contactoNombre: "Mariano Pereyra", email: "[email protected]", telefono: "+54 11 4892-1003", estado: "activo", direccion: "Av. del Libertador 4521, Vicente López, BA", desde: "2021-03-12", polizasActivas: 14, montoMensual: 2840000 },
  { id: "C002", tipo: "normal", nombre: "Sofía", apellido: "Mansilla", dni: "32.450.198", email: "[email protected]", telefono: "+54 11 5634-7821", estado: "activo", direccion: "Tucumán 1280 4°B, CABA", desde: "2023-08-04", polizasActivas: 2, montoMensual: 84300 },
  { id: "C003", tipo: "corp", razonSocial: "Frigorífico Las Heras S.R.L.", cuit: "30-69384761-2", contactoNombre: "Andrea Cabezas", email: "[email protected]", telefono: "+54 261 423-9018", estado: "activo", direccion: "Ruta 7 km 1042, Las Heras, Mendoza", desde: "2019-11-20", polizasActivas: 22, montoMensual: 5210000 },
  { id: "C004", tipo: "normal", nombre: "Lucas", apellido: "Bressán", dni: "28.917.044", email: "[email protected]", telefono: "+54 351 612-4488", estado: "activo", direccion: "Bv. Chacabuco 980, Córdoba", desde: "2022-02-18", polizasActivas: 3, montoMensual: 142500 },
  { id: "C005", tipo: "corp", razonSocial: "Constructora Andina S.A.", cuit: "30-70812346-9", contactoNombre: "Federico Ítalo", email: "[email protected]", telefono: "+54 11 4313-7700", estado: "activo", direccion: "San Martín 200 P10, CABA", desde: "2020-06-09", polizasActivas: 31, montoMensual: 7820000 },
  { id: "C006", tipo: "normal", nombre: "Carolina", apellido: "Iturralde", dni: "35.108.276", email: "[email protected]", telefono: "+54 223 481-9920", estado: "baja", direccion: "Mitre 3402, Mar del Plata", desde: "2024-01-15", polizasActivas: 0, montoMensual: 0 },
  { id: "C007", tipo: "normal", nombre: "Diego", apellido: "Quintana", dni: "30.781.633", email: "[email protected]", telefono: "+54 11 6128-3045", estado: "activo", direccion: "Honduras 4880, CABA", desde: "2021-09-27", polizasActivas: 4, montoMensual: 218900 },
  { id: "C008", tipo: "corp", razonSocial: "AgroTech Pampa S.R.L.", cuit: "30-71398205-4", contactoNombre: "Verónica Pini", email: "[email protected]", telefono: "+54 2317 45-2901", estado: "activo", direccion: "Av. San Martín 821, Pehuajó, BA", desde: "2022-10-11", polizasActivas: 9, montoMensual: 1640000 },
  { id: "C009", tipo: "normal", nombre: "Romina", apellido: "Ledesma", dni: "33.219.847", email: "[email protected]", telefono: "+54 11 5811-7720", estado: "activo", direccion: "Migueletes 1430, CABA", desde: "2023-04-22", polizasActivas: 1, montoMensual: 38400 },
  { id: "C010", tipo: "normal", nombre: "Tomás", apellido: "Olmedo", dni: "29.504.612", email: "[email protected]", telefono: "+54 11 6724-1899", estado: "activo", direccion: "Av. Cabildo 2102, CABA", desde: "2020-12-03", polizasActivas: 5, montoMensual: 312000 },
  { id: "C011", tipo: "corp", razonSocial: "Distribuidora Pampa Verde S.A.", cuit: "30-70234118-1", contactoNombre: "Esteban Rugiero", email: "[email protected]", telefono: "+54 341 562-0044", estado: "activo", direccion: "Pellegrini 1850, Rosario", desde: "2018-05-30", polizasActivas: 18, montoMensual: 3950000 },
  { id: "C012", tipo: "normal", nombre: "Agustina", apellido: "Vázquez", dni: "34.882.301", email: "[email protected]", telefono: "+54 11 5028-3367", estado: "activo", direccion: "Av. Las Heras 2890, CABA", desde: "2024-07-19", polizasActivas: 2, montoMensual: 96700 },
];

// ============== ASEGURADORAS ==============
const ASEGURADORAS = [
  { id: "A01", razonSocial: "La Federal Seguros S.A.", cuit: "30-50001234-1", contacto: "Pablo Granados", email: "[email protected]", telefono: "+54 11 4339-9000", direccion: "Av. Corrientes 1380, CABA", polizasActivas: 142, color: "#1e5fc7" },
  { id: "A02", razonSocial: "Sancor Cooperativa de Seguros", cuit: "30-50002378-8", contacto: "Verónica Calabró", email: "[email protected]", telefono: "+54 3493 42-8000", direccion: "Tucumán 2761, Sunchales", polizasActivas: 98, color: "#0d8a5f" },
  { id: "A03", razonSocial: "Provincia ART", cuit: "30-50091344-2", contacto: "Marcelo Filloy", email: "[email protected]", telefono: "+54 11 4378-3300", direccion: "Carlos Pellegrini 91, CABA", polizasActivas: 64, color: "#7c3aed" },
  { id: "A04", razonSocial: "Galicia Seguros S.A.", cuit: "30-66891022-5", contacto: "Luciana Frondizi", email: "[email protected]", telefono: "+54 11 6329-0000", direccion: "Tte. Gral. J.D. Perón 456, CABA", polizasActivas: 87, color: "#d97706" },
  { id: "A05", razonSocial: "Mercantil Andina", cuit: "30-50001876-3", contacto: "Gustavo Lerner", email: "[email protected]", telefono: "+54 261 405-9000", direccion: "Av. España 1242, Mendoza", polizasActivas: 41, color: "#b42318" },
];
...
const SINIESTROS = [
  {
    id: "S-2026-0118",
    numero: "SIN-2026-0118",
    clienteId: "C002",
    polizaId: "P-2024-0918",
    fecha: "2026-05-07",
    fechaReporte: "2026-05-07T18:42:00",
    estado: "nuevo",
    ...
    leido: false,
    docs: [
      { tipo: "img", nombre: "frente_auto.jpg", tamaño: "2.4 MB", ai: true },
      { tipo: "img", nombre: "danos_atras.jpg", tamaño: "3.1 MB", ai: true },
      { tipo: "img", nombre: "patente_otro.jpg", tamaño: "1.8 MB", ai: true },
  ...
  {
    id: "S-2026-0117",
    numero: "SIN-2026-0117",
    clienteId: "C001",
    polizaId: "P-2023-7782",
    fecha: "2026-05-06",
    fechaReporte: "2026-05-06T11:15:00",
    estado: "nuevo",
    ...
    leido: false,
    docs: [
      { tipo: "pdf", nombre: "denuncia_robo.pdf", tamaño: "0.6 MB", ai: false },
      { tipo: "img", nombre: "ultima_ubicacion.jpg", tamaño: "0.9 MB", ai: true },
    ],
  ...
  {
    id: "S-2026-0116",
    numero: "SIN-2026-0116",
    clienteId: "C003",
    polizaId: "P-2024-0011",
    fecha: "2026-05-04",
    fechaReporte: "2026-05-04T09:30:00",
    estado: "tramite",
    ...
    leido: true,
    docs: [
      { tipo: "img", nombre: "techo_filtra.jpg", tamaño: "1.7 MB", ai: true },
      { tipo: "img", nombre: "camara_3.jpg", tamaño: "2.2 MB", ai: true },
      { tipo: "pdf", nombre: "presupuesto_compresor.pdf", tamaño: "0.3 MB", ai: false },
      { tipo: "pdf", nombre: "lista_productos_perdidos.pdf", tamaño: "0.2 MB", ai: false },
    ],
  ...
  {
    id: "S-2026-0115",
    numero: "SIN-2026-0115",
    clienteId: "C004",
    polizaId: "P-2024-0334",
    fecha: "2026-04-29",
    fechaReporte: "2026-04-29T20:11:00",
    estado: "tramite",
    ...
    leido: true,
    docs: [
      { tipo: "img", nombre: "techo.jpg", tamaño: "2.1 MB", ai: true },
      { tipo: "img", nombre: "capot.jpg", tamaño: "1.9 MB", ai: true },
      { tipo: "img", nombre: "luneta.jpg", tamaño: "2.4 MB", ai: true },
    ],
  ...
  {
    id: "S-2026-0114",
    numero: "SIN-2026-0114",
    clienteId: "C005",
    polizaId: "P-2025-0188",
    fecha: "2026-04-25",
    fechaReporte: "2026-04-25T14:22:00",
    estado: "tramite",
    ...
    leido: true,
    docs: [
      { tipo: "pdf", nombre: "denuncia_art.pdf", tamaño: "0.4 MB", ai: false },
      { tipo: "pdf", nombre: "informe_medico.pdf", tamaño: "0.7 MB", ai: false },
    ],
    aiSummary: "Accidente laboral con baja médica estimada 30 días. ART activada. Pendiente: alta médica del paciente.",
  },
  {
    id: "S-2026-0113",
    numero: "SIN-2026-0113",
    clienteId: "C007",
    polizaId: "P-2024-1531",
    fecha: "2026-04-22",
    fechaReporte: "2026-04-22T08:45:00",
    estado: "tramite",
    ...
    leido: true,
    docs: [
      { tipo: "img", nombre: "auto_sin_espejo.jpg", tamaño: "1.2 MB", ai: true },
      { tipo: "pdf", nombre: "exposicion.pdf", tamaño: "0.2 MB", ai: false },
    ],
  ...
  },
  {
    ...
    fecha: "2026-04-15",
    fechaReporte: "2026-04-15T17:00:00",
    estado: "cerrado",
    ...
    leido: true,
    docs: [
      { tipo: "img", nombre: "rayadura.jpg", tamaño: "0.9 MB", ai: true },
    ],
    aiSummary: "Caso cerrado por acuerdo entre partes. No requirió uso de cobertura.",
  },
  {
    id: "S-2026-0111",
    numero: "SIN-2026-0111",
    clienteId: "C008",
    polizaId: "P-2024-2018",
    fecha: "2026-04-08",
    fechaReporte: "2026-04-08T10:30:00",
    estado: "cerrado",
    ...
    leido: true,
    docs: [
      { tipo: "pdf", nombre: "informe_perito.pdf", tamaño: "1.2 MB", ai: false },
      { tipo: "img", nombre: "lote_7_aerea.jpg", tamaño: "3.8 MB", ai: true },
    ],
...
const PAGOS_MASIVOS = [
  ...
  },
  {
    ...
    periodo: "Mayo 2026",
    estado: "validado",
    metodoPago: "Cheque diferido",
    comprobante: "CHQ-00084492",
    cbu: "—",
    items: [
...
// helpers
const clienteLabel = (c) => c.tipo === "corp" ? c.razonSocial : `${c.nombre} ${c.apellido}`;
const clienteIdent = (c) => c.tipo === "corp" ? c.cuit : c.dni;
const clienteAvatarLetters = (c) =>
  c.tipo === "corp"
    ? c.razonSocial.split(" ").filter(w => w.length > 2).slice(0, 2).map(w => w[0]).join("").toUpperCase()
    : `${c.nombre?.[0] || ""}${c.apellido?.[0] || ""}`;

const findCliente = (id) => CLIENTES.find(c => c.id === id);
const findAseguradora = (id) => ASEGURADORAS.find(a => a.id === id);
const findPoliza = (id) => POLIZAS.find(p => p.id === id);

const polizaTotal = (pago) => pago.items.reduce((s, i) => s + i.monto, 0);

// Compute días hasta vencimiento
const daysUntilExpiry = (poliza) => daysBetween(TODAY, poliza.fin);

window.PolData = {
  TODAY, fmtAR, fmtNum, fmtDate, daysBetween, daysUntilExpiry,
  CLIENTES, ASEGURADORAS, POLIZAS, SINIESTROS, PAGOS_MASIVOS,
  clienteLabel, clienteIdent, clienteAvatarLetters,
  findCliente, findAseguradora, findPoliza, polizaTotal,
};
