...
const STORAGE_KEY = "polizing-sidebar-collapsed";
    ...
    >
      <div className="flex items-center gap-2.5 px-[18px] py-4 border-b border-border min-h-16">
        ...
        <button
          ...
          className="ml-auto w-7 h-7 grid place-items-center border border-border bg-card rounded-md text-muted-foreground hover:bg-brand-surface-hover hover:text-foreground shrink-0"
        >
